        ...
        <ol className="list-decimal  sm:marker:text-xl marker:font-semibold space-y-8 pl-5 md:pl-8">
          ...
          <li>
            ...
            <ul className="list-disc pl-5 md:pl-8 space-y-3 text-base md:text-lg leading-relaxed">
              ...
              <li>
                Services are provided based on the plan you select.
              </li>
              <li>
                Additional services beyond your plan may incur extra charges.
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul className="list-disc pl-5 md:pl-8 space-y-3 text-base md:text-lg leading-relaxed">
              <li className="mt-3">
                You must provide access to your WordPress site and hosting.
              </li>
              <li>
                Inform us about major changes like new plugins or themes.
              </li>
              <li>
                You should maintain backups; we cannot guarantee full restoration.
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul className="list-disc pl-5 md:pl-8 space-y-3 text-base md:text-lg leading-relaxed">
              <li className="mt-3">
                Fees depend on your selected plan; payments are due upon invoice.
              </li>
              <li>
                Late payments may incur a 5% monthly fee.
              </li>
              <li>
                Payments will be collected via direct debit.
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul className="list-disc pl-5 md:pl-8 space-y-3 text-base md:text-lg leading-relaxed">
              <li className="mt-3">
                Either party may end services with 30 days’ written notice.
              </li>
              <li>
                No refunds for unused services in a billing period.
              </li>
              <li>
                We may terminate the agreement for non-payment or breach.
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul className="list-disc pl-5 md:pl-8 space-y-3 text-base md:text-lg leading-relaxed">
              <li className="mt-3">
                We provide maintenance but cannot guarantee error-free service.
              </li>
              <li>
                We are not liable for issues caused by hosting, cyberattacks, or third-party software.
              </li>
              <li>
                We are not responsible for data loss during maintenance.
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul className="list-disc pl-5 md:pl-8 space-y-3 text-base md:text-lg leading-relaxed">
              <li className="mt-3">
                Both parties agree to maintain confidentiality unless required by law.
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul className="list-disc pl-5 md:pl-8 space-y-3 text-base md:text-lg leading-relaxed">
              <li className="mt-3">
                You agree to indemnify WPWebsiteFix from claims arising from your website.
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul className="list-disc pl-5 md:pl-8 space-y-3 text-base md:text-lg leading-relaxed">
              <li className="mt-3">
                Your website’s intellectual property remains yours.
              </li>
              <li>
                WPWebsiteFix retains ownership of tools or processes developed.
              </li>
            </ul>
          </li>
