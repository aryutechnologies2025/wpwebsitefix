...
const page = () => {
  ...
  const pageUrl = "https://wpwebsitefix.com/privacy-policy/";
    ...
    "@graph": [
      {
        ...
        "@id": `${pageUrl}#webpage`,
        url: pageUrl,
        name: "Privacy Policy | WPWebsiteFix",
        isPartOf: { "@id": `${brandUrl}/#website` },
        breadcrumb: { "@id": `${pageUrl}#breadcrumb` },
        dateModified: new Date().toISOString(), // Automatically updates the "Last Modified" for Google
      },
      {
        "@type": "BreadcrumbList",
      ...
      <div>
        ...
        <main className="p-6 md:p-12 lg:p-20 mt-5 md:mt-0 space-y-8 font-visby">
          ...
          <p className="text-base md:text-lg leading-relaxed">
            ...
            maintenance and support services. By continuing to browse our site
            or engage with our services, you agree to the data practices
          ...
          <ol className="list-decimal  sm:marker:text-xl marker:font-semibold space-y-8 pl-5 md:pl-8">
            ...
            <li>
              ...
              <p className="mt-3 text-base md:text-lg leading-relaxed pl-1">
                We do not sell, trade, or rent your personal information. Data
                is only shared with trusted service providers who help us
                operate our website and deliver services, and they must protect
                your information.
              </p>
            </li>
            ...
            <li>
              ...
              <p className="mt-3 text-base md:text-lg leading-relaxed pl-1">
                ...
                functionality, analyze traffic, and personalize content. You can
                disable cookies, but some features may not work properly.
              </p>
            </li>
            ...
            <li>
              ...
              <p className="mt-3 text-base md:text-lg leading-relaxed pl-1">
                ...
                deletion of your personal information. You may opt out of
                marketing communication anytime. Depending on your region, you
                may have additional rights under GDPR or CCPA.
              </p>
            </li>
            ...
            <li>
              ...
              <p className="mt-3 text-base md:text-lg leading-relaxed pl-1">
                ...
                services, fulfill policy purposes, or comply with legal
                obligations. Once no longer needed, we securely delete or
                anonymize data.
              </p>
            </li>
