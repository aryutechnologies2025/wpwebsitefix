...
export const metadata= {
  ...
  description:
    "Create visually stunning, high-performing WordPress themes with our expert WordPress Theme Development Services. Start now to boost usability & grow business.",
 keywords:"WordPress Theme Development Services"
};
